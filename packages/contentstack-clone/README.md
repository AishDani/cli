...
- [@contentstack/cli-cm-clone](#contentstack@contentstack/cli-cm-clone)
- [Usage](#usage)
- [Commands](#commands)
<!-- tocstop -->
...
```
USAGE
  $ csdx cm:stacks:clone [--source-branch <value>] [--target-branch <value>] [--source-@contentstack/management-token-alias <value>]
    [--destination-@contentstack/management-token-alias <value>] [-n <value>] [--type a|b] [--source-stack-api-key <value>]
