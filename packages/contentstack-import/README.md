...
[![License](https://img.shields.io/npm/l/cli)](https://github.com/contentstack/cli/blob/main/LICENSE)it -m
...
```sh-session
$ npm install -g cli-cm-import
$ csdx COMMAND
running command...
$ csdx (--version)
cli-cm-import/1.16.5 darwin-arm64 node-v21.6.1
$ csdx --help [COMMAND]
USAGE
  $ csdx COMMAND
...
