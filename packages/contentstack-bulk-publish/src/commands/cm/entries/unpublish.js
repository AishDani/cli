      ...
      if (!updatedFlags.retryFailed) {
        ...
        if (updatedFlags.alias) {
          try {
            ...
            this.error(
              `The configured @contentstack/management token alias ${updatedFlags.alias} has not been added yet. Add it using 'csdx auth:tokens:add --alias ${updatedFlags.alias}'`,
              { exit: 2 },
            );
          }
